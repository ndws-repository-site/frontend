...
import type { AdminPaginationProps } from "../types/admin-pagination.props";
...
/**
 * Пагинация для админ-таблиц.
 * Скрывается при totalPages <= 1.
 */
export const AdminPagination = ({
    ...
    return (
        <div
            className={cn(
                "flex items-center justify-center gap-1.5 pt-6 pb-2",
                className,
            )}
        >
