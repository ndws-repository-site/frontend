...
/**
 * Загрузка файла админки. Поддержка drag-and-drop, превью имени, удаление.
 * Варианты: standard, alternative. По умолчанию accept="image/*".
 */
export const AdminFileUpload = ({
    ...
    const handleDrop = (e: DragEvent<HTMLDivElement>) => {
        ...
        if (droppedFile) {
            if (accept === "image/*" && !droppedFile.type.startsWith("image/"))
                return;
    ...
    return (
        <div className="w-full flex flex-col">
            ...
            >
                ...
                <div className="shrink-0 text-[#656565]">
                    {file ? (
                        <div
