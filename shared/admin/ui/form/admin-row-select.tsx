...
/**
 * Компактный выпадающий выбор в строках таблицы. Открывается порталом, позиция по кнопке.
 */
            ...
            <div className={cn("w-full min-w-[140px]", className)}>
                <button
                    ...
                    className={cn(
                        ...
                        isOpen
                            ? "rounded-b-none bg-[#252525] border-white/5"
                            : "",
                    )}
                >
                    ...
                    >
                        <ChevronDown
                            size={16}
                            className="text-gray-500 group-hover:text-white transition-colors shrink-0 ml-2"
                        />
                    </motion.div>
                </button>
            </div>
