...
/**
 * Один пункт навигации боковой панели: иконка + название, активное состояние.
 */
        ...
        >
            <div
                className={cn(
                    ...
                    active
                        ? "bg-[#151515]"
                        : "bg-white group-hover:bg-[#151515]",
                )}
            >
                <Icon
                    className={cn(
                        ...
                        active
                            ? "text-white"
                            : "text-[#151515] group-hover:text-white",
                    )}
                />
            </div>
            ...
            <span
                className={cn(
                    ...
                    active
                        ? "text-[#151515]"
                        : "text-white group-hover:text-[#151515]",
                )}
            >
                {name}
            </span>
