        ...
        <RoundedBlock className="p-2.5 relative flex flex-col justify-between mob:min-h-[1000px] min-h-[518px]">
            ...
            <div className="text-center leading-none">
                <div className="flex justify-center">
                    ...
                    >
                        NDWS is a brand for those who do not look for excuses.
                        For those who understand that results are not achieved
                        in a single day, but through hundreds of correct
                        decisions in a row.
                    </motion.h2>
                </div>
                ...
                >
                    <Text
                        size="medium"
                        variant="white"
                        className="mb-4.5 font-light"
                    >
                        Sport is not a mood. It is a habit. It is discipline.
                        <br /> It is a choice you make every day.
                    </Text>
                </motion.div>
                ...
                >
                    <Text size="medium" variant="white" className="font-light">
                        No day without sport —<br /> it&apos;s not a slogan.
                        It&apos;s a way of life.
                    </Text>
                </motion.div>
            </div>
