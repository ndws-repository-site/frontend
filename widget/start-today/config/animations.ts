...
export const startTodayIdleMotions: StartTodayIdleMotion[] = [
    { y: [0, -12, 0], x: [0, 4, 0], rotate: [0, 4, -2, 0], duration: 4.5, delay: 0 },
    { y: [0, 10, -6, 0], rotate: [0, -5, 3, 0], duration: 5.2, delay: 0.4 },
    { y: [0, -14, 0], x: [0, -4, 0], rotate: [0, -3, 5, 0], duration: 4.8, delay: 0.2 },
    { y: [0, 8, 0], rotate: [0, 2, -4, 0], duration: 5.0, delay: 0.6 },
    { y: [0, -10, 6, 0], rotate: [0, 6, -2, 0], duration: 4.6, delay: 0.3 },
    { y: [0, 6, -10, 0], x: [0, 3, 0], rotate: [0, -4, 4, 0], duration: 5.4, delay: 0.5 },
    { y: [0, -8, 0], x: [0, -3, 0], rotate: [0, 3, -3, 0], duration: 4.4, delay: 0.1 },
