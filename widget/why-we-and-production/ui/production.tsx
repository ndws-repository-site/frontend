        ...
        <div className="mob:mb-13.5 mb-8">
            ...
            <div className="grid lg:grid-cols-3 mob:grid-cols-2 grid-cols-1 lg:gap-12 mob:gap-5.5 gap-3">
                ...
                <Text size="medium" className={TEXT_PRODUCTION_CLASSES}>
                    Every NDWS product undergoes strict quality control. Our
                    goal is to ensure that you feel confident about what you
                    consume every day.
                </Text>

                <Text size="medium" className={TEXT_PRODUCTION_CLASSES}>
                    We work only with trusted manufacturing facilities in
                    Florida and use raw materials that meet international
                    standards.
                </Text>
            </div>
        </div>
